...
import * as mockedSceneExportUtils from "@misenkashari/excalidraw/scene/export";
import { diagramFactory } from "@misenkashari/excalidraw/tests/fixtures/diagramFixture";
