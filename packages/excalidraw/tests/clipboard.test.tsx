...
import { KEYS, arrayToMap, getLineHeight } from "@misenkashari/excalidraw-common";

import { getElementBounds } from "@misenkashari/excalidraw-element";
...
vi.mock("@misenkashari/excalidraw-common", async (importOriginal) => {
